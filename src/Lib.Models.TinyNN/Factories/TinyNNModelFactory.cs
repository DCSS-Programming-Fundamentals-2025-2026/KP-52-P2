...
namespace Lib.Models.TinyNN.Factories
{
    ...
    {
        public TinyNNModel CreateNewModel(string modelKind, int vocabSize, int embeddingSize = 128, int contextSize = 8192)
        {
        ...
        public ILanguageModel CreateFromPayload(JsonElement payload, string modelKind)
        {
            if (modelKind != "tinynn")
            {
